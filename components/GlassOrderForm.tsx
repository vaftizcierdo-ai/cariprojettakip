                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Tedarikçi sipariş numarası"
                            style={inputStyle}
                            onFocus={(e) => {
                                e.currentTarget.style.background = 'rgba(255, 255, 255, 0.08)';
                                e.currentTarget.style.borderColor = 'rgba(6, 182, 212, 0.5)';
                    ...
                    <div>
                        ...
                        >
                            <option value="Ordered" style={{ background: '#1a1a2a' }}>Sipariş Verildi</option>
                            <option value="InProgress" style={{ background: '#1a1a2a' }}>Üretimde</option>
                            <option value="Delivered" style={{ background: '#1a1a2a' }}>Teslim Edildi</option>
                        </select>
                    </div>
                </div>
            </div>
