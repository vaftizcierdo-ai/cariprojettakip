...
export default async function GlassOrdersPage() {
    ...
    // ✅ projesi silinmiş olan siparişleri gizle
    const visibleOrders = orders.filter((o) => o.project || (o as any).customProjectName);
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <Link href="/dashboard/glass-orders/new" style={{ textDecoration: 'none' }}>
                    <div
                                        ...
                                        >
                                            ...
                                            >
                                                <div style={{ fontWeight: 500, color: '#e8e8f0', marginBottom: '0.25rem' }}>
                                                    {order.project?.description ?? (order as any).customProjectName ?? 'Silinmiş Proje'}

                                                </div>
                                                <div style={{ fontSize: '0.75rem', color: '#6b6b80' }}>
                                                    {order.project?.clientName || order.project?.companyName || (order as any).customClientName || '-'}
