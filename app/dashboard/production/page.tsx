...
export default async function ProductionPage({
    ...
    const visibleJobs = jobs.filter((j: any) => j.project || j.customProjectName);
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {job.project?.description ?? job.customProjectName}
                                    </h3>
                                    ...
                                    {job.estimatedEndDate && (
                                        <div
                                            style={{
                                                ...
                                                gap: '0.5rem',
                                                color:
                                                    new Date() > new Date(job.estimatedEndDate) && job.status !== 'Finished'
                                                        ? '#f87171'
                                                        : '#6b6b80',
                                                fontWeight:
                                                    new Date() > new Date(job.estimatedEndDate) && job.status !== 'Finished'
